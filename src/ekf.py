...
def main():
    ...
    #dy, H, M = meas(s, shat, featuresseen, v)

    #print('meas dy')
    #print(dy)
    #print('model H')
    #print(H)
    #print('non-additive correction matrix M')
    #print(M.shape)
    #print(M)

    #shat, P = meas_update(H, dy, np.copy(Pnew), v, shat, M)

    #print('post meas update P')
    #print(P)
    #print('post meas update state')
    #print(s)
    #print('post meas update estimated state')
    #print(shat)
